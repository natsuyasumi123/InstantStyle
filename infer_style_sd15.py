...
if neg_content is not None:
    ...
    text_encoder = CLIPTextModelWithProjection.from_pretrained("../CLIP-ViT-H-14-laion2B-s32B-b79K").to(pipe.device, 
                                                                                                           dtype=pipe.dtype)
    tokenizer = CLIPTokenizer.from_pretrained("../CLIP-ViT-H-14-laion2B-s32B-b79K")
...
images[0].save("infer_style_sd15.png")